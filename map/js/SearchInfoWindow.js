...
(function() {
  ...
  /**
    ...
    SearchInfoWindow.prototype.setToHereAddr=function(x,y){
        this._myAddress={
            _x:x,
            _y:y
        }
      ...
      _dispatchEvent: function(instance, type, opts) {
                            ...
                            '<ul class="BMapLib_nav_tab_content">', //tab内容
                                '<li id="BMapLib_searchBox' + this.guid + '">',
                                    '<table width="100%" align="center" border=0 cellpadding=0 cellspacing=0>',
                                        '<tr><td style="padding-left:8px;width:40px;"><input id="BMapLib_search_text' + this.guid + '" class="BMapLib_search_text" type="text" maxlength="100" autocomplete="off"></td><td width="55" style="padding-left:7px;"><input id="BMapLib_search_nb_btn' + this.guid + '" type="submit" value="搜索" class="iw_bt"></td></tr>',
                                    '</table>',
                                '</li>',
                                '<li id="BMapLib_transBox' + this.guid + '" style="display:none">',
                                    '<table width="100%" align="center" border=0 cellpadding=0 cellspacing=0>',
                                        '<tr><td width="30" style="padding-left:8px;width:40px;"><div id="BMapLib_stationText' + this.guid + '">起点</div></td><td><input id="BMapLib_trans_text' + this.guid + '" class="BMapLib_trans_text" type="text" maxlength="100" autocomplete="off"></td><td width="106" style="padding-left:7px;"><input id="BMapLib_search_bus_btn' + this.guid + '" type="button" value="公交" class="iw_bt" style="margin-right:5px;"><input id="BMapLib_search_drive_btn' + this.guid + '" type="button" class="iw_bt" value="驾车"></td></tr>',
                                    '</table>',
                                '</li>',
                            '</ul>',
                        '</div>',
        ...
        _transitRouteAction: function (transitDrive) {
            ...
            if (kw == "") {
                ...
                if(this._myAddress && !!(this._myAddress._x) && !!(this._myAddress._y)&&this.dom.transText.value==="我的位置"){
                    transPoi.start=new BMap.Point(this._myAddress._x,this._myAddress._y);
                }
